...
- Age-related **clonal hematopoiesis** (CH; somatic mutations in the blood-forming system) and its **somatic-germline interplay**, with implications for managing CH-associated diseases.

- **Omics-based** instruments for testing **causal hypothesis** in studying diseases.

- **Disease risk prediction** using static (germline genetic) and dynamic (time-varying fators) data (in collaboration with <a href="https://www.dbei.med.upenn.edu/bio/jin-jin-0" target="_blank">Dr. Jin Jin</a>).
